...
hi User1                  cterm=none  ctermfg=15   ctermbg=6
hi User2		  cterm=none  ctermfg=15   ctermfg=8
hi Title                  cterm=none  ctermfg=8    ctermbg=0
...
highlight Constant   cterm=none      ctermfg=11
"highlight Number   	 term=underline ctermfg=DarkGrey
...
highlight Type       ctermfg=13      cterm=italic
highlight Ignore     ctermfg=0
highlight Error      ctermfg=0       ctermbg=4
highlight Todo       ctermfg=15      ctermbg=1
highlight SignColumn ctermbg=3       ctermfg=15
...
highlight Exception      ctermfg=10 ctermbg=0
highlight Function       ctermfg=14
highlight Typedef        ctermfg=10 ctermbg=8
highlight SpecialChar    ctermfg=15 ctermbg=4
highlight Delimiter      ctermfg=15 ctermbg=1
highlight SpecialComment ctermfg=11 ctermbg=8

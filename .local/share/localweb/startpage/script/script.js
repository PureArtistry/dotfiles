const CONFIGObj = {{
  ...
  defaultSuggestions: {{
    ...
    r: ['r/r/unixporn', 'r/r/dota2', 'r/r/wallpapers'],
  }},
...
class Form {{
  ...
  reverse() {{
    if (this._reverseColors) {{
      document.documentElement.style.setProperty('--background', '{color15}');
      document.documentElement.style.setProperty('--foreground', '{color0}');
    }}
  }}

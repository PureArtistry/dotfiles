...
sys.path.append(os.path.join(conf_path, 'qutebrowser'))
...
## Type: ShellCommand
c.editor.command = ['alacritty', '-e', 'size_fix.sh', 'nvim', '{file}', '-c', 'normal {line}G{column0}l']
...
## Newer version config additions

## Setting to request websites to reduce non-essential motion/animations.
## Type: Bool
# c.content.prefers_reduced_motion = True

## Setting to customize the text color for selected items in filename prompts.
## Type: QtColor
# c.colors.prompts.selected.fg = base07
